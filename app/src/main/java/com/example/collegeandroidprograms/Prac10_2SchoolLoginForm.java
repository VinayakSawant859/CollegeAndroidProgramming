...
public class Prac10_2SchoolLoginForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentloginBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Prac10_2SchoolLoginForm.this, "Login Successful!", Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(Prac10_2SchoolLoginForm.this, "Login Unsuccessful!", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
