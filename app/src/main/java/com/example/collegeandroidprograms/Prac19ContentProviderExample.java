...
public class Prac19ContentProviderExample extends AppCompatActivity {
    ...
    public void onClickAddDetails(View view) {
        ...
        values.put(Prac19StudentsProvider.name, ((EditText)        findViewById(R.id.userTXT)).getText().toString());
        getContentResolver().insert(Prac19StudentsProvider.CONTENT_URI, values);
