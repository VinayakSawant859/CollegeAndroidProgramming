...
public class Prac20_2MyService extends Service {
    private static final String TAG = "Prac20_2MyService";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Toast.makeText(this, "Prac20_2MyService Started.", Toast.LENGTH_SHORT).show();
    ...
    private final class MyServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            synchronized (this) {
                for (int i = 0; i < 10; i++) {
                    try {
                        Log.i(TAG, "Prac20_2MyService running...");
                        Thread.sleep(1000);
                    } catch (Exception e) {
