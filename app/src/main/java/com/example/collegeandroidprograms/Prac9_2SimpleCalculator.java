...
public class Prac9_2SimpleCalculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(Prac9_2SimpleCalculator.this, "Enter Required Numbers!", Toast.LENGTH_SHORT).show();
                }
            }
        });
