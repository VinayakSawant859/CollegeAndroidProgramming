...
public class Prac11FiveCheckBoxes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mumbai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mumbai.isChecked()){
                    Toast.makeText(Prac11FiveCheckBoxes.this, "Your selected city is Mumbai!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        chennai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (chennai.isChecked()){
                    Toast.makeText(Prac11FiveCheckBoxes.this, "Your selected city is Chennai!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        kolkata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (kolkata.isChecked()){
                    Toast.makeText(Prac11FiveCheckBoxes.this, "Your selected city is Kolkata!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        delhi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (delhi.isChecked()){
                    Toast.makeText(Prac11FiveCheckBoxes.this, "Your selected city is Delhi!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        jaipur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (jaipur.isChecked()){
                    Toast.makeText(Prac11FiveCheckBoxes.this, "Your selected city is Jaipur!", Toast.LENGTH_SHORT).show();
                }
            }
        });
